...
final class BrokerAgentProfileTests: XCTestCase {
    ...
    func test_builtInProfiles_offerStandardWorkAsAutomaticModelChoices() {
        for profile in BrokerAgentProfile.builtIns {
            ...
            XCTAssertTrue(candidates.contains { $0.model == "gpt-6-sol" }, profile.name)
    ...
    func test_builtIns_carryTheExpectedExploreAndVerificationChains() {
        ...
        XCTAssertEqual(
            ...
            ["claude-haiku-4-5-20251001:default", "gpt-6-luna:medium", "claude-sonnet-5:low"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.balanced, role: "verification"),
            ["claude-sonnet-5:high", "gpt-6-sol:medium", "claude-haiku-4-5-20251001:default"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.conserveQuota, role: "explore"),
            ["claude-haiku-4-5-20251001:default", "gpt-6-luna:medium"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.conserveQuota, role: "verification"),
            ["gpt-6-sol:low", "claude-sonnet-5:medium", "claude-haiku-4-5-20251001:default"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.maxQuality, role: "explore"),
            ["claude-sonnet-5:medium", "gpt-6-luna:high", "claude-haiku-4-5-20251001:default"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.maxQuality, role: "verification"),
            ["claude-opus-5-5:high", "claude-sonnet-5:high", "gpt-6-sol:medium"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.offloadExecution, role: "explore"),
            ["gpt-6-luna:medium", "claude-haiku-4-5-20251001:default", "claude-sonnet-5:low"]
        )
        XCTAssertEqual(
            signature(BrokerAgentProfile.offloadExecution, role: "verification"),
            ["gpt-6-sol:medium", "claude-sonnet-5:high", "claude-haiku-4-5-20251001:default"]
        )
    }
    ...
    func test_maxQuality_keepsAReserveOnTheSharedChatGPTWindow() {
        ...
        XCTAssertLessThanOrEqual(
            ...
            "execution and standard reach this same window through gpt-6-sol, so raising "
