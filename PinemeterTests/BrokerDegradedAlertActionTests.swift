...
//  settings tab instead of an action that provably does nothing.
//
...
final class BrokerDegradedAlertActionTests: XCTestCase {
    ...
    func test_buttonTitle_namesTheActionItPerforms() {
        ...
        XCTAssertEqual(BrokerDegradedAlertAction.openBrokerSettings.buttonTitle, "Open Broker Settings")
