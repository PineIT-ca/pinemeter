...
final class BrokerHTTPServerTests: XCTestCase {
    ...
    func test_auditGradesSuppliedSourcesAndReturnsTheContract() async throws {
        let complete = """
            ...
            `source: human-override`. Never infer, persist, or reuse it. Never bypass Pinemeter for an override.
            """
    ...
    func test_pickWithExplicitOverride_returnsAuditableOneCallDecision() async throws {
        ...
        let pick = try await send(jsonRPC: [
            ...
            "params": [
                ...
                "arguments": [
                    "role": "planning",
                    "caller": "codex",
                    "override_candidate": "t3/gpt-5.6-sol",
                ],
            ],
        ])
        ...
        XCTAssertEqual(decision["model"] as? String, "t3/gpt-5.6-sol")
