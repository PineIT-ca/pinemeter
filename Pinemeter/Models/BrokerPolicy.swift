...
struct BrokerPolicy: Codable, Equatable, Sendable {
    ...
    func usageLane(for candidate: BrokerCandidate) -> BrokerUsageLane? {
        ...
        guard let shared = usageLanes["t3/\(candidate.model)"],
              case .chatGPT = shared else { return nil }
        return shared
    }
    ...
    static let bundledDefault: BrokerPolicy = {
        ...
        return BrokerPolicy(
            ...
            usageLanes: [
                ...
                "t3/gpt-5.6-terra": .chatGPT(labelContains: "codex weekly"),
                "codex/gpt-5.6-terra": .chatGPT(labelContains: "codex weekly"),
                "t3/gpt-5.6-luna": .chatGPT(labelContains: "codex weekly"),
                "codex/gpt-5.6-luna": .chatGPT(labelContains: "codex weekly"),
            ],
            agentModelAliases: [
