...
extension BrokerPolicy {
    ...
    static let bundledDefault: BrokerPolicy = {
        ...
        let researchChain: [BrokerCandidate] = [
            ...
            BrokerCandidate(route: .auto, model: "gpt-5.6-sol", effort: .high),
        ...
        // uses low effort for high-volume subagent work.
        roles["explore"] = [
        ...
        roles["verification"] = [
            BrokerCandidate(route: .auto, model: "claude-sonnet-5", effort: .high),
            BrokerCandidate(route: .auto, model: "gpt-5.6-terra", effort: .high),
            BrokerCandidate(route: .auto, model: "claude-haiku-4-5-20251001"),
        ]
        roles["execution"] = [
            BrokerCandidate(route: .auto, model: "gpt-5.6-sol", effort: .high),
        ...
        // Heavy work raises all three candidates to xhigh because the hardest
        // coding guidance and unattended completion rates improve with effort.
        roles["heavy"] = [
            BrokerCandidate(route: .auto, model: "gpt-6-astra", effort: .medium),
            BrokerCandidate(route: .auto, model: "claude-opus-5-5", effort: .xhigh),
            BrokerCandidate(route: .auto, model: "claude-sonnet-5", effort: .xhigh),
            BrokerCandidate(route: .auto, model: "gpt-5.6-sol", effort: .xhigh),
        ]
        // Standard work keeps Sonnet first, then Terra at half Sol's credit
        // rate. Sol stays next so older apps without Terra lanes reach Codex.
        roles["standard"] = [
            BrokerCandidate(route: .auto, model: "claude-sonnet-5", effort: .high),
            BrokerCandidate(route: .auto, model: "gpt-5.6-terra", effort: .medium),
            BrokerCandidate(route: .auto, model: "gpt-5.6-sol", effort: .medium),
        ...
        return BrokerPolicy(
            ...
            models: [
                ...
                "gpt-6-astra": BrokerModelSpec(
                    quota: .chatGPT(labelContains: "codex weekly"),
                    effort: BrokerEffortCapability(levels: BrokerEffort.builtInLevels, nilLabel: "Provider default")
                ),
