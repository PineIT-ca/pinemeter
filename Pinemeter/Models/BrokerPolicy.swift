...
extension BrokerPolicy {
    ...
    static let bundledDefault: BrokerPolicy = {
        ...
        // Planning leads with Opus 5 because it is the stated default and has
        // the best measured cost per completed task.
        let planningChain: [BrokerCandidate] = [
            BrokerCandidate(route: .auto, model: "claude-opus-5", effort: .xhigh),
        ...
        let researchChain: [BrokerCandidate] = [
            BrokerCandidate(route: .auto, model: "claude-fable-5-1"),
            BrokerCandidate(route: .auto, model: "claude-opus-5", effort: .high),
            BrokerCandidate(route: .auto, model: "claude-sonnet-5", effort: .high),
        ]
        // Review stays on Opus 5 because it is the highest-volume judgment role
