...
extension BrokerAgentProfile {
    ...
    static let conserveQuota: BrokerAgentProfile = {
        ...
        // judgment because Haiku scores poorly there, while Luna and low-effort
        // Sol reduce Codex credit burn for execution and short standard work.
        rules.setChain(for: judgmentRoles, [
            ...
            BrokerCandidate(route: .codex, model: "gpt-6-sol", effort: .medium),
        ...
        rules.setChain(for: ["explore"], [
            BrokerCandidate(route: .native, model: "claude-haiku-4-5-20251001"),
            BrokerCandidate(route: .t3, model: "gpt-6-luna", effort: .medium),
            BrokerCandidate(route: .codex, model: "gpt-6-luna", effort: .medium),
        ])
        rules.setChain(for: ["verification"], [
            BrokerCandidate(route: .t3, model: "gpt-6-sol", effort: .low),
            BrokerCandidate(route: .codex, model: "gpt-6-sol", effort: .low),
        ...
        rules.setChain(for: ["heavy"], [
            ...
            BrokerCandidate(route: .t3, model: "gpt-6-sol", effort: .medium),
            BrokerCandidate(route: .codex, model: "gpt-6-sol", effort: .medium),
        ])
        rules.setChain(for: ["standard"], [
            BrokerCandidate(route: .native, model: "claude-haiku-4-5-20251001"),
            BrokerCandidate(route: .t3, model: "gpt-6-luna", effort: .high),
            BrokerCandidate(route: .codex, model: "gpt-6-luna", effort: .high),
            BrokerCandidate(route: .t3, model: "gpt-6-sol", effort: .low),
            BrokerCandidate(route: .codex, model: "gpt-6-sol", effort: .low),
            BrokerCandidate(route: .native, model: "claude-sonnet-5", effort: .medium),
        ])
    ...
    static let maxQuality: BrokerAgentProfile = {
        ...
        // high for heavy work, where harder coding benefits most from effort.
        ...
        rules.setChain(for: ["heavy"], [
            ...
            BrokerCandidate(route: .t3, model: "gpt-6-sol", effort: .high),
            BrokerCandidate(route: .codex, model: "gpt-6-sol", effort: .high),
        ])
        rules.setChain(for: ["standard"], [
            BrokerCandidate(route: .native, model: "claude-sonnet-5", effort: .high),
            BrokerCandidate(route: .native, model: "claude-opus-5-5", effort: .high),
        ...
        // (`execution` and `standard` reach it through gpt-6-sol), so it
    ...
    static let offloadExecution: BrokerAgentProfile = {
        var rules = BrokerRuleSet.default
        // Codex stays first for writing code. Luna leads explore as the
        // cheapest Codex lane, and low-effort Sol leads standard work.
        rules.setChain(for: ["execution"], [
            BrokerCandidate(route: .codex, model: "gpt-6-sol", effort: .medium),
            BrokerCandidate(route: .t3, model: "gpt-6-sol", effort: .medium),
            BrokerCandidate(route: .native, model: "claude-sonnet-5", effort: .high),
