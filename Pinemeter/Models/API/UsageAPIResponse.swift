...
struct UsageAPIResponse: Codable {
    ...
    /// A dashboard UI flag, not a quota-data availability flag.
    var memberDashboardAvailable: Bool? = nil
...
enum MappingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .usageUnavailable:
            return "Claude usage dashboard is unavailable for this account"
        }
    }
}
...
extension UsageAPIResponse {
    func toDomain() throws -> UsageData {
        ...
        if memberDashboardAvailable == false,
           fiveHour == nil, sevenDay == nil,
           sessionEntry == nil, weeklyEntry == nil {
            throw MappingError.usageUnavailable
        }
