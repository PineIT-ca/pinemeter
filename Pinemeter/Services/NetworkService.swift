...
actor NetworkService: NetworkServiceProtocol {
    ...
    /// Ephemeral by default: this path sends the Claude sessionKey as a Cookie
    /// header, and a shared `.default` configuration would let a server
    /// `Set-Cookie` rotation land in the on-disk cookie jar. The credential
    /// belongs in the Keychain only.
