...
extension Notification.Name {
    ...
    /// Opens Settings on the Accounts pane. Separate from
    /// ``openBrokerSettings`` because that one forces the Broker tab, and a
    /// disconnected provider is repaired in Accounts.
