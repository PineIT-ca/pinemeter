...
actor ChatGPTUsageService: ChatGPTUsageServiceProtocol {
    ...
    func fetchUsage() async throws -> ChatGPTUsageData {
        ...
        do {
            return try await fetchUsageAndPersist(sessionCookie: session.sessionCookie)
    ...
    private func fetchUsageAndPersist(sessionCookie: String) async throws -> ChatGPTUsageData {
        let (usage, accessToken) = try await fetchUsageAndAccessToken(sessionCookie: sessionCookie)
        try await sessionRepository.save(
            ChatGPTSession(sessionCookie: sessionCookie, accessToken: accessToken),
