...
actor BrokerMCPServer {
    ...
    static var downTool: Tool {
        Tool(
            ...
            `target` is a cooldown key: a full candidate id (e.g. t3:claude_secondary/claude-fable-5), \
    ...
    /// the Instructions tab can say when this machine was last checked. The
    ...
    /// is persisted and drawn verbatim in the Instructions tab. A path carrying
