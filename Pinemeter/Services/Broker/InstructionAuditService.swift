...
actor InstructionAuditService {
    ...
    nonisolated static func contractChecklist(endpoint: String) -> [String] {
    ...
    nonisolated static var nestedContractLine: String {
    ...
    private nonisolated static let nestedDirective = Directive(
    ...
    private nonisolated static func declaredTools(in text: String) -> String? {
