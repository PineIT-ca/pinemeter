...
//
//  Everything in this pane is machine state that no profile may carry. Model
//  chains do not name these rows; the broker matches detected capability and
//  live quota at pick time.
//
...
struct BrokerInstancesPane: View {
    ...
    private var addableDiscoveredInstances: [DiscoveredT3Instance] {
        BrokerWindowView.addableDiscoveredInstances(
