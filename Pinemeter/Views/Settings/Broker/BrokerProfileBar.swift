...
struct BrokerProfileBar: View {
    ...
    private var canSaveInPlace: Bool { activeProfile.map { !$0.isBuiltIn } ?? false }
                    ...
                    BrokerChip(text: "Edited", systemImage: "pencil", tint: .orange, style: .outline)
                        .help(
                            canSaveInPlace
                                ...
                                : "The rules below no longer match this built-in profile. "
                                    + "Duplicate it to keep the changes."
                        )
                }
                ...
                if isEdited {
                    if canSaveInPlace {
                        ...
                        Button("Duplicate\u{2026}") { beginNamingNewProfile() }
                            .buttonStyle(.borderedProminent)
                            .controlSize(.small)
                            .help("Built-in profiles cannot be overwritten. Save these rules as your own.")
                    }
    ...
    private var pendingSwitchMessage: String {
        ...
        return canSaveInPlace
            ...
            : "Built-in profiles cannot be overwritten, so these edits will be lost."
    }
